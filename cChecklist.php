...
if (isset($_GET['apagar'])) {
    ...
    $msg = ($resposta) 
        ? 'Item removido do recurso com sucesso.' 
        : 'Não foi possível remover este item, pois ele está vinculado a uma retirada.';
    ...
    if (strlen($_GET['txtitem']) >= 3) {
        ...
        // Erro
        $msg = 'O nome do item deve conter no mínimo 3 caracteres.';
    }
}
